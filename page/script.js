/*
  ...
  IMPORTANTE:
  - Pegá la URL de tu Apps Script UNA sola vez en APPS_SCRIPT_URL.
  - Si el contador no se mueve, abrí la consola (F12) para ver errores de JS.
*/

// ============================================================
// CONFIGURACIÓN PRINCIPAL (EDITAR AQUÍ)
// ============================================================
// Pegá aquí la URL /exec del deployment web de Google Apps Script (solo una vez)
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  // Validación básica de existencia de elementos (si falta algo, se corta acá)
